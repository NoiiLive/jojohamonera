...
public class ModelSpeedwagonHatBlade<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "speedwagonhatblade"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hat = partdefinition.addOrReplaceChild("hat",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-5.5F, 4.0F, -5.5F, 11.0F, 1.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(0, 12)
						.addBox(-4.5F, 0.0F, -4.5F, 9.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, 19.0F, 0.0F, 0.0F, -1.5708F, 1.5708F));

		PartDefinition cube_r1 = hat.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(4, 12).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F,
		...
		PartDefinition cube_r5 = hat.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -2.0F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.25F, 2.25F, 0.5F, 0.0F, 0.0F, 0.0873F));
