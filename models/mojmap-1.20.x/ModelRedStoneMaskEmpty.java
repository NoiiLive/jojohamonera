...
public class ModelRedStoneMaskEmpty<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "redstonemaskempty"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition socket = mask.addOrReplaceChild("socket", CubeListBuilder.create().texOffs(24, 12).addBox(-1.0F,
				-2.9301F, -0.4928F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
