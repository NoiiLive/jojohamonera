...
public class ModelBloodyStoneMask<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bloodystonemask"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition details = mask.addOrReplaceChild("details", CubeListBuilder.create().texOffs(0, 13).addBox(0.25F,
				-2.325F, -0.75F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.25F, -6.675F, -4.75F));

		PartDefinition cube_r7 = details.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(12, 11).addBox(-1.5F, -1.5F, -1.0F, 3.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = spike1.addOrReplaceChild("cube_r8",
		...
		PartDefinition cube_r9 = spike1.addOrReplaceChild("cube_r9",
		...
		PartDefinition cube_r10 = spike1.addOrReplaceChild("cube_r10",
		...
		PartDefinition cube_r13 = spike2.addOrReplaceChild("cube_r13",
		...
		PartDefinition cube_r14 = spike3.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(9, 20).addBox(-0.5F, -0.5F, -1.5F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0849F, 0.0F, 1.9861F, 0.0F, -0.5672F, 0.0F));

		PartDefinition cube_r15 = spike3.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(14, 21).addBox(-0.5F, -0.5F, -1.5F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.3297F, 0.0F, -0.2489F, 0.0F, 0.3491F, 0.0F));

		PartDefinition cube_r16 = spike3.addOrReplaceChild("cube_r16",
		...
		PartDefinition cube_r17 = spike4.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(0, 20).addBox(-0.5F, -0.5F, -1.5F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0849F, 0.0F, 1.9861F, 0.0F, 0.5672F, 0.0F));

		PartDefinition cube_r18 = spike4.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(20, 0).addBox(-0.5F, -0.5F, -1.5F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3297F, 0.0F, -0.2489F, 0.0F, -0.3491F, 0.0F));

		PartDefinition cube_r19 = spike4.addOrReplaceChild("cube_r19",
		...
		PartDefinition cube_r20 = spike5.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(17, 17).addBox(-0.5F, -0.5F, -1.5F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0849F, 0.0F, 1.9861F, 0.0F, 0.5672F, 0.0F));

		PartDefinition cube_r21 = spike5.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(19, 13).addBox(-0.5F, -0.5F, -1.5F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3297F, 0.0F, -0.2489F, 0.0F, -0.3491F, 0.0F));

		PartDefinition cube_r22 = spike5.addOrReplaceChild("cube_r22",
		...
		PartDefinition cube_r23 = spike6.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(12, 16).addBox(-0.5F, -0.5F, -1.5F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0849F, 0.0F, 1.9861F, 0.0F, 0.5672F, 0.0F));

		PartDefinition cube_r24 = spike6.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(17, 6).addBox(-0.5F, -0.5F, -1.5F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3297F, 0.0F, -0.2489F, 0.0F, -0.3491F, 0.0F));

		PartDefinition cube_r25 = spike6.addOrReplaceChild("cube_r25",
		...
		PartDefinition cube_r28 = blood.addOrReplaceChild("cube_r28",
