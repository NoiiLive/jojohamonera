...
import net.mcreator.jojohe.network.HumanSkillTreeRangedButtonMessage;
...
public class HumanSkillTreeRangedScreen extends AbstractContainerScreen<HumanSkillTreeRangedMenu> {
	private final static HashMap<String, Object> guistate = HumanSkillTreeRangedMenu.guistate;
	...
	public HumanSkillTreeRangedScreen(HumanSkillTreeRangedMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("jojohe:textures/screens/human_skill_tree_ranged.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + -41 && mouseX < leftPos + -28 && mouseY > topPos + -107 && mouseY < topPos + -88)
			guiGraphics.renderTooltip(font, Component.translatable("gui.jojohe.human_skill_tree_ranged.tooltip_support"), mouseX, mouseY);
		if (mouseX > leftPos + 28 && mouseX < leftPos + 41 && mouseY > topPos + -107 && mouseY < topPos + -88)
			guiGraphics.renderTooltip(font, Component.translatable("gui.jojohe.human_skill_tree_ranged.tooltip_physical"), mouseX, mouseY);
	}
	...
	public void init() {
		...
		imagebutton_guiarrow_left = new ImageButton(this.leftPos + -41, this.topPos + -107, 13, 19, 0, 0, 19, new ResourceLocation("jojohe:textures/screens/atlas/imagebutton_guiarrow_left.png"), 13, 38, e -> {
			if (true) {
				JojoheMod.PACKET_HANDLER.sendToServer(new HumanSkillTreeRangedButtonMessage(0, x, y, z));
				HumanSkillTreeRangedButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_gui_arrow = new ImageButton(this.leftPos + 28, this.topPos + -107, 13, 19, 0, 0, 19, new ResourceLocation("jojohe:textures/screens/atlas/imagebutton_gui_arrow.png"), 13, 38, e -> {
			if (true) {
				JojoheMod.PACKET_HANDLER.sendToServer(new HumanSkillTreeRangedButtonMessage(1, x, y, z));
				HumanSkillTreeRangedButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_stat_guibutton = new ImageButton(this.leftPos + -12, this.topPos + -11, 22, 22, 0, 0, 22, new ResourceLocation("jojohe:textures/screens/atlas/imagebutton_stat_guibutton.png"), 22, 44, e -> {
			if (true) {
				JojoheMod.PACKET_HANDLER.sendToServer(new HumanSkillTreeRangedButtonMessage(2, x, y, z));
				HumanSkillTreeRangedButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
