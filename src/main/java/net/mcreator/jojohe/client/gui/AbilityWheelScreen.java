...
import net.mcreator.jojohe.network.AbilityWheelButtonMessage;
...
public class AbilityWheelScreen extends AbstractContainerScreen<AbilityWheelMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("jojohe:textures/screens/ability_wheel.png");
	...
	public void init() {
		...
		imagebutton_guiarrow_down = new ImageButton(this.leftPos + -10, this.topPos + 55, 19, 13, 0, 0, 13, new ResourceLocation("jojohe:textures/screens/atlas/imagebutton_guiarrow_down.png"), 19, 26, e -> {
			if (WheelSwitchDisplayProcedure.execute(world, entity)) {
				JojoheMod.PACKET_HANDLER.sendToServer(new AbilityWheelButtonMessage(0, x, y, z));
