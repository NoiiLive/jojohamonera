...
import net.mcreator.jojohe.network.VampireSkillTreePhysicalButtonMessage;
...
public class VampireSkillTreePhysicalScreen extends AbstractContainerScreen<VampireSkillTreePhysicalMenu> {
	private final static HashMap<String, Object> guistate = VampireSkillTreePhysicalMenu.guistate;
	...
	public VampireSkillTreePhysicalScreen(VampireSkillTreePhysicalMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("jojohe:textures/screens/vampire_skill_tree_physical.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 30 && mouseX < leftPos + 43 && mouseY > topPos + -107 && mouseY < topPos + -88)
			guiGraphics.renderTooltip(font, Component.translatable("gui.jojohe.vampire_skill_tree_physical.tooltip_ranged"), mouseX, mouseY);
		if (mouseX > leftPos + -44 && mouseX < leftPos + -31 && mouseY > topPos + -107 && mouseY < topPos + -88)
			guiGraphics.renderTooltip(font, Component.translatable("gui.jojohe.vampire_skill_tree_physical.tooltip_movement"), mouseX, mouseY);
	}
	...
	public void init() {
		...
		imagebutton_guiarrow_left = new ImageButton(this.leftPos + -44, this.topPos + -107, 13, 19, 0, 0, 19, new ResourceLocation("jojohe:textures/screens/atlas/imagebutton_guiarrow_left.png"), 13, 38, e -> {
			if (true) {
				JojoheMod.PACKET_HANDLER.sendToServer(new VampireSkillTreePhysicalButtonMessage(0, x, y, z));
				VampireSkillTreePhysicalButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_gui_arrow = new ImageButton(this.leftPos + 30, this.topPos + -107, 13, 19, 0, 0, 19, new ResourceLocation("jojohe:textures/screens/atlas/imagebutton_gui_arrow.png"), 13, 38, e -> {
			if (true) {
				JojoheMod.PACKET_HANDLER.sendToServer(new VampireSkillTreePhysicalButtonMessage(1, x, y, z));
				VampireSkillTreePhysicalButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_stat_guibutton = new ImageButton(this.leftPos + -12, this.topPos + 28, 22, 22, 0, 0, 22, new ResourceLocation("jojohe:textures/screens/atlas/imagebutton_stat_guibutton.png"), 22, 44, e -> {
			if (true) {
				JojoheMod.PACKET_HANDLER.sendToServer(new VampireSkillTreePhysicalButtonMessage(2, x, y, z));
				VampireSkillTreePhysicalButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
