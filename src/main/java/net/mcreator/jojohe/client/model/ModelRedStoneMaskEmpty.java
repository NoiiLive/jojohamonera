...
public class ModelRedStoneMaskEmpty<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("jojohe", "model_red_stone_mask_empty"), "main");
	public final ModelPart mask;

	public ModelRedStoneMaskEmpty(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition socket = mask.addOrReplaceChild("socket", CubeListBuilder.create().texOffs(24, 12).addBox(-1.0F, -2.9301F, -0.4928F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -4.2199F, -4.8072F));
