...
public class ShadowbornRootCMDProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if ((((new Object() {
			...
			if (entity instanceof Player _player && !_player.level().isClientSide())
				...
				}.getEntity()).getDisplayName().getString() + "'s Root Changed to Shadowborn")), false);
			if ((new Object() {
				public Entity getEntity() {
					try {
						return EntityArgument.getEntity(arguments, "name");
				...
				_player.displayClientMessage(Component.literal("Root Changed to Shadowborn!"), true);
		} else {
			if (entity instanceof Player _player && !_player.level().isClientSide())
