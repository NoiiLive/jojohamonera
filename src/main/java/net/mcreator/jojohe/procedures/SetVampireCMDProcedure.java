...
public class SetVampireCMDProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		}
		{
			...
			}.getEntity()).getCapability(JojoheModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JojoheModVariables.PlayerVariables())).MaxBloodBar;
			(new Object() {
				public Entity getEntity() {
					try {
						return EntityArgument.getEntity(arguments, "name");
		...
		if ((new Object() {
			...
			_player.displayClientMessage(Component.literal("Your Ability has been changed to Vampire"), true);
		if (entity instanceof Player _player && !_player.level().isClientSide())
			...
			}.getEntity()).getDisplayName().getString() + "Player's Ability has been set to Vampire")), false);
