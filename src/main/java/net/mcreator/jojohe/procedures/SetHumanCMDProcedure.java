...
public class SetHumanCMDProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if ((new Object() {
			...
			_player.displayClientMessage(Component.literal("Your Ability has been changed to Human"), true);
		if (entity instanceof Player _player && !_player.level().isClientSide())
			...
			}.getEntity()).getDisplayName().getString() + "'s Ability has been set to Human")), false);
		CMDResetAbilitiesProcedure.execute(arguments);
		CMDResetStatsProcedure.execute(arguments);
		CMDResetHamonProcedure.execute(world, x, y, z, arguments);
