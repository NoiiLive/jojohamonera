...
public class Vampire2Entity extends Monster {
	public Vampire2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.VAMPIRE_2.get(), world);
	}

	public Vampire2Entity(EntityType<Vampire2Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 1;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(JojoheModEntities.VAMPIRE_2.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
