...
import net.mcreator.jojohe.procedures.TeachVampireProcedure;
...
public class DioBrandoEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DioBrandoEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DioBrandoEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DioBrandoEntity.class, EntityDataSerializers.STRING);
	...
	public DioBrandoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.DIO_BRANDO.get(), world);
	}

	public DioBrandoEntity(EntityType<DioBrandoEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(JojoheModItems.DIO_ARMOR_CHESTPLATE.get()));
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "diobrandotexture");
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(JojoheModItems.STONE_MASK_HELMET.get()));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TeachVampireProcedure.execute(world, x, y, z, sourceentity);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(JojoheModEntities.DIO_BRANDO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(DioBrandoEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
