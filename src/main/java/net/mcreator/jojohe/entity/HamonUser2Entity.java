...
public class HamonUser2Entity extends Monster {
	public HamonUser2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.HAMON_USER_2.get(), world);
	}

	public HamonUser2Entity(EntityType<HamonUser2Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 1;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(JojoheModEntities.HAMON_USER_2.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
