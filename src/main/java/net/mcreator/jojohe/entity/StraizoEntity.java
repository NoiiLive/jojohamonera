...
public class StraizoEntity extends Monster {
	public StraizoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.STRAIZO.get(), world);
	}

	public StraizoEntity(EntityType<StraizoEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 10;
		setNoAi(false);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(JojoheModItems.STRAIZO_ARMOR_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(JojoheModItems.STRAIZO_ARMOR_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(JojoheModItems.STRAIZO_ARMOR_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(JojoheModItems.STRAIZO_ARMOR_BOOTS.get()));
	}
