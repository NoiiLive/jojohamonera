...
import net.mcreator.jojohe.procedures.TeachWisdomProcedure;
...
public class TonpettyEntity extends Monster {
	public TonpettyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.TONPETTY.get(), world);
	}

	public TonpettyEntity(EntityType<TonpettyEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 10;
		setNoAi(false);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(JojoheModItems.TONPETTY_ARMOR_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(JojoheModItems.TONPETTY_ARMOR_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(JojoheModItems.TONPETTY_ARMOR_BOOTS.get()));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TeachWisdomProcedure.execute(world, x, y, z, sourceentity);
		return retval;
	}
