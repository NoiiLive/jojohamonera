...
public class TarkusEntity extends Monster {
	public TarkusEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.TARKUS.get(), world);
	}

	public TarkusEntity(EntityType<TarkusEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 10;
		setNoAi(false);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(JojoheModItems.TARKUS_GREATSWORD.get()));
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(JojoheModItems.TARKUS_ARMOR_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(JojoheModItems.TARKUS_ARMOR_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(JojoheModItems.TARKUS_ARMOR_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(JojoheModItems.TARKUS_ARMOR_BOOTS.get()));
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(JojoheModItems.TARKUS_GREATSWORD.get()));
	}
