...
public class Vampire4Entity extends Monster {
	public Vampire4Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.VAMPIRE_4.get(), world);
	}

	public Vampire4Entity(EntityType<Vampire4Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 1;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(JojoheModEntities.VAMPIRE_4.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
