...
public class Vampire3Entity extends Monster {
	public Vampire3Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.VAMPIRE_3.get(), world);
	}

	public Vampire3Entity(EntityType<Vampire3Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 1;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(JojoheModEntities.VAMPIRE_3.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
