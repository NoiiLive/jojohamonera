...
import net.mcreator.jojohe.procedures.TeachBloodProcedure;
...
public class BloodDioEntity extends Monster {
	public BloodDioEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.BLOOD_DIO.get(), world);
	}

	public BloodDioEntity(EntityType<BloodDioEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 10;
		setNoAi(false);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(JojoheModItems.DIO_ARMOR_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(JojoheModItems.DIO_ARMOR_BOOTS.get()));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TeachBloodProcedure.execute(world, x, y, z, sourceentity);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(JojoheModEntities.BLOOD_DIO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
