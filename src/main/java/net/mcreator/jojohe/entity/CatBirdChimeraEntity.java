...
public class CatBirdChimeraEntity extends TamableAnimal {
	public CatBirdChimeraEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.CAT_BIRD_CHIMERA.get(), world);
	}

	public CatBirdChimeraEntity(EntityType<CatBirdChimeraEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CatBirdChimeraEntity retval = JojoheModEntities.CAT_BIRD_CHIMERA.get().create(serverWorld);
