...
import net.mcreator.jojohe.procedures.TeachNecroProcedure;
...
public class NecroDioEntity extends Monster {
	public NecroDioEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.NECRO_DIO.get(), world);
	}

	public NecroDioEntity(EntityType<NecroDioEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 10;
		setNoAi(false);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(JojoheModItems.INJURED_DIO_CLOAK_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(JojoheModItems.INJURED_DIO_CLOAK_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(JojoheModItems.INJURED_DIO_CLOAK_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(JojoheModItems.INJURED_DIO_CLOAK_BOOTS.get()));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TeachNecroProcedure.execute(world, x, y, z, sourceentity);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(JojoheModEntities.NECRO_DIO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
