...
import net.mcreator.jojohe.procedures.TeachDefenderProcedure;
...
public class DireEntity extends Monster {
	public DireEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.DIRE.get(), world);
	}

	public DireEntity(EntityType<DireEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 10;
		setNoAi(false);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(JojoheModItems.DIRE_ARMOR_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(JojoheModItems.DIRE_ARMOR_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(JojoheModItems.DIRE_ARMOR_BOOTS.get()));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TeachDefenderProcedure.execute(world, x, y, z, sourceentity);
		return retval;
	}
