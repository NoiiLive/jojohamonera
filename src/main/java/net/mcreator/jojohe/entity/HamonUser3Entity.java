...
public class HamonUser3Entity extends Monster {
	public HamonUser3Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.HAMON_USER_3.get(), world);
	}

	public HamonUser3Entity(EntityType<HamonUser3Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 1;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(JojoheModEntities.HAMON_USER_3.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
