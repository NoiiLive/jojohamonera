...
public class HamonUser1Entity extends Monster {
	public HamonUser1Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.HAMON_USER_1.get(), world);
	}

	public HamonUser1Entity(EntityType<HamonUser1Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 1;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(JojoheModEntities.HAMON_USER_1.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
