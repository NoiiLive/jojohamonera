...
public class JonathanJoestarEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(JonathanJoestarEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(JonathanJoestarEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(JonathanJoestarEntity.class, EntityDataSerializers.STRING);
	...
	public JonathanJoestarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojoheModEntities.JONATHAN_JOESTAR.get(), world);
	}

	public JonathanJoestarEntity(EntityType<JonathanJoestarEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(JojoheModItems.PLUCK.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(JojoheModItems.JONATHAN_ARMOR_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(JojoheModItems.JONATHAN_ARMOR_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(JojoheModItems.JONATHAN_ARMOR_BOOTS.get()));
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "jonathanjoestartexture");
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(JojoheModItems.PLUCK.get()));
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(JonathanJoestarEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
