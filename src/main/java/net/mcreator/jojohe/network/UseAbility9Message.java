...
import net.mcreator.jojohe.procedures.KeybindAbility9Procedure;
...
public class UseAbility9Message {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			KeybindAbility9Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		JojoheMod.addNetworkMessage(UseAbility9Message.class, UseAbility9Message::buffer, UseAbility9Message::new, UseAbility9Message::handler);
	}
}
