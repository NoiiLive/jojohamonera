...
import net.mcreator.jojohe.procedures.KeybindAbility5Procedure;
...
public class UseAbility5Message {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			KeybindAbility5Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		JojoheMod.addNetworkMessage(UseAbility5Message.class, UseAbility5Message::buffer, UseAbility5Message::new, UseAbility5Message::handler);
	}
}
