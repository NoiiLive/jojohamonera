...
import net.mcreator.jojohe.procedures.KeybindAbility4Procedure;
...
public class UseAbility4Message {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JojoheMod.addNetworkMessage(UseAbility4Message.class, UseAbility4Message::buffer, UseAbility4Message::new, UseAbility4Message::handler);
	}
}
