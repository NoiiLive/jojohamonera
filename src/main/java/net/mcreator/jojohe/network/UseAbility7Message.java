...
import net.mcreator.jojohe.procedures.KeybindAbility7Procedure;
...
public class UseAbility7Message {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			KeybindAbility7Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		JojoheMod.addNetworkMessage(UseAbility7Message.class, UseAbility7Message::buffer, UseAbility7Message::new, UseAbility7Message::handler);
	}
}
