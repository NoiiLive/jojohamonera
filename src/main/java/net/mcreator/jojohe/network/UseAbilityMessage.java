...
import net.mcreator.jojohe.procedures.UseAbilityKeybindProcedure;
...
public class UseAbilityMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JojoheMod.addNetworkMessage(UseAbilityMessage.class, UseAbilityMessage::buffer, UseAbilityMessage::new, UseAbilityMessage::handler);
	}
}
