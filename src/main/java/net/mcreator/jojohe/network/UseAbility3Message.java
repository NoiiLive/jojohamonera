...
import net.mcreator.jojohe.procedures.KeybindAbility3Procedure;
...
public class UseAbility3Message {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			KeybindAbility3Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		JojoheMod.addNetworkMessage(UseAbility3Message.class, UseAbility3Message::buffer, UseAbility3Message::new, UseAbility3Message::handler);
	}
}
