...
public class AbilityWheelButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JojoheMod.addNetworkMessage(AbilityWheelButtonMessage.class, AbilityWheelButtonMessage::buffer, AbilityWheelButtonMessage::new, AbilityWheelButtonMessage::handler);
	}
}
