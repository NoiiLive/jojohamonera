...
public class HermitChangeButtonMessage {
	private final int buttonID, x, y, z;

	public HermitChangeButtonMessage(FriendlyByteBuf buffer) {
	...
	public HermitChangeButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(HermitChangeButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(HermitChangeButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = HermitChangeMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JojoheMod.addNetworkMessage(HermitChangeButtonMessage.class, HermitChangeButtonMessage::buffer, HermitChangeButtonMessage::new, HermitChangeButtonMessage::handler);
	}
}
