...
import net.mcreator.jojohe.procedures.KeybindAbility1Procedure;
...
public class UseAbility1Message {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JojoheMod.addNetworkMessage(UseAbility1Message.class, UseAbility1Message::buffer, UseAbility1Message::new, UseAbility1Message::handler);
	}
}
