...
import net.mcreator.jojohe.procedures.KeybindAbility2Procedure;
...
public class UseAbility2Message {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JojoheMod.addNetworkMessage(UseAbility2Message.class, UseAbility2Message::buffer, UseAbility2Message::new, UseAbility2Message::handler);
	}
}
